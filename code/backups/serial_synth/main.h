...
static const SectionConfig Section_1 = {
    ...
    .banks    = { 0, 0, 0, 0, 0, 0, 128, 128 },
    .programs = { 2, 2, 0, 2, 5, 6, 0, 1 }
};

/* ---------- Section 2 ---------- */
static const SectionConfig Section_2 = {
    .offsets = { 32, 0, 0, 0, -16, 0, 32, 0 },
    .notes = {
    ...
    .banks    = { 0, 0, 128, 0, 0, 128, 0, 0 },
    .programs = { 4, 104, 0, 0, 1, 16, 0, 82 }
};

/* ---------- Section 3 ---------- */
static const SectionConfig Section_3 = {
    .offsets = { 24, -32, 24, 0, -16, 16, 63, 63 },
    .notes = {
